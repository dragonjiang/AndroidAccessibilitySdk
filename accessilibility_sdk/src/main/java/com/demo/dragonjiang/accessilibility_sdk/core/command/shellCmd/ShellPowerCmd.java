 ...
 * @description
 */
public class ShellPowerCmd extends BaseCmd {

    private static final String TAG = "ShellPowerCmd";

    @Override
    public Observable<Integer> executeObservable() {
        final String cmd = ShellCmdUtil.buildKeyEventCmd(ShellCmdUtil.KEY_CODE.KEYCODE_POWER);
