 ...
 * @description
 */
public class ShellBackCmd extends BaseCmd {

    private static final String TAG = "ShellBackCmd";

    @Override
    public Observable<Integer> executeObservable() {
        final String cmd = ShellCmdUtil.buildKeyEventCmd(ShellCmdUtil.KEY_CODE.KEYCODE_BACK);
