 ...
 */
package com.example.nd99u.utils.log.manager;

import android.app.Activity;
import android.content.Context;
import android.util.Log;

import com.example.nd99u.utils.log.task.LogTask;
...
public class LogManagerImpl implements ILogManager, UncaughtExceptionHandler {
        ...
        if (LogUtils.sdAvailible()) {
            try {
                ...
                OutputStreamWriter writer = new OutputStreamWriter(trace,
                        "utf-8");
                writer.write(LogUtils.encrypt(result));
                writer.flush();
    ...
    private String buildCrashLog(String msg) {
        ...
        sb.append(LogUtils.buildSystemInfo(mContext));
        sb.append("\n");
